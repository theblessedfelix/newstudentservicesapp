...
import Level1StudentManagement from "../admin/pages/Level1StudentManagement";
import Level2StudentManagement from "../admin/pages/Level2StudentManagement";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "level-1", Component: Level1StudentManagement },
      { path: "level-2", Component: Level2StudentManagement },
